---
name: conventions-mermaid
description: >-
  MANDATORY for any work on Mermaid files (*.mmd, *.mermaid) or Mermaid
  diagram blocks in Markdown. Load this before creating, editing, or
...
1. Write the Mermaid source to a unique path under `/tmp/`, such as
   ...
   or image.
2. Use the bundled stylesheet [`mermaid.css`](../conventions-mermaid/mermaid.css)
