...
install-pi: install-tools
	...
	@for package in git:github.com/Integralist/pi-statusbar npm:pi-effort npm:@shuv1337/pi-mcp-adapter npm:pi-intercom npm:pi-subagents git:github.com/Integralist/pi-btw; do \
