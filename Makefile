...
install-pi: install-tools
	...
	@for package in git:github.com/Integralist/pi-statusbar npm:pi-effort npm:@shuv1337/pi-mcp-adapter npm:pi-intercom git:github.com/Integralist/pi-subagents git:github.com/Integralist/pi-btw; do \
